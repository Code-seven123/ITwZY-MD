...
async function startSock(){
  ...
  setInterval(() => {
    console.log("Auto saved store.json")
    logger.info("Auto saved store.json")
  ...
  const chatAi = aiModel.startChat({
    history: [
      {
        role: "user",
        parts: [{ text: "Buat anda sebagai perempuan dengan reaksi imut dan penuh emosi dan juga buat reaksi kamu se manusia mungkin" }]
      }
    ]
  })
